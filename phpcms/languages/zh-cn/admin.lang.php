...
//index
$LANG['admin_site_title'] = 'KALEOSITE - 后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['phpcms_title'] = 'KALEOSITE内容管理系统';
...
$LANG['main_version'] = 'KALEOSITE程序版本：';
...
$LANG['main_product_team'] = 'KALEOSITE系统开发团队';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 KALEOSITE可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
KALEOSITE可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
